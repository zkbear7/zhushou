...
## 代码结构（v11·7.26 明日预览+真橙777）

- `DRAWER_SECTIONS[]`：侧边抽屉 9 个面板（v10全面更新）
  - 数学面板：依赖关系验证·顺序重排·880大章学完再刷
  - 828面板：12h/周·英语日晚间课后题·现控埃德加选看
  - 英语面板：v10高ROI选听·柴荣阅读+新题型+写作方法论·易熙人完型选听5篇·唐静翻译·自搭模板
  - 政治面板：马原12讲✅·带刷隔天二四日
  - 进度自检：v10四科里程碑·考研12.19预测
  - 健身面板：居家弹力带隔天二四六(35min)
  - 周计划面板：v10全科路线·秋季课表预警
  - Tips面板：v10各科关键提醒汇总
...
- `isPoliticalClassDay()`：政治学习日（马原期✅+带刷隔天二四日）
- `getSchedule()`：v9作息（9点起·弹力带隔天二四六·自控日/英语日）
- `buildDailySubjectCard()`：主页今日每科任务卡片
- 打卡系统：`localStorage` 持久化 + 完成率统计 + 7日柱状图
- SW缓存版本：v15（7.26 明日任务预览+真橙777更新）
